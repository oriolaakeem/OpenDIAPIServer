...
namespace SupplyChain.Models
{
    public class OIGN
    {
        ...
        public string U_CA_Number { get; set; }
        public string U_UniRef { get; set; }
        public Nullable<int> U_Batch { get; set; }
        public Nullable<int> U_TermType { get; set; }
        public Nullable<int> U_RefBatch { get; set; }
    }
}
